namespace DA1_DictationGame
{
    partial class Help
    {
        ...
        private void InitializeComponent()
        {
			...
			this.label1.Text = "=> You need to choose level, remember, type your name!";
			// 
			// label2
			// 
			...
			this.label2.Text = "=> Each level has 10 question for you, you can use hint when";
			// 
			// label3
			// 
			...
			this.label5.Text = "=> If you don\'t complete 10 question in each level, your name";
			// 
			// label7
			// 
			...
			this.label7.Text = "=> The time is limited ( maximum: 9999 second)";
			// 
			// label8
			// 
			...
			this.label8.Text = "you can\'t listen the voice, but the hint is limited (3times)";
			// 
			// label9
			// 
			...
			this.label9.Text = "won\'t be written on the High Score list.";
			// 
			// label10
			// 
			this.label10.AutoSize = true;
			this.label10.Font = new System.Drawing.Font("Microsoft Sans Serif", 20F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.label10.Location = new System.Drawing.Point(101, 439);
